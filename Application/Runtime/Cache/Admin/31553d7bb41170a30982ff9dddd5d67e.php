            ...
            <div class="col-lg-6">
                ...
                <form class="form-horizontal" id="singcms-form">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input type="radio" name="type" value="1" checked title="前端栏目"> 前端栏目
                            <input type="radio" name="type" value="2" title="后台菜单"> 后台菜单
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input type="text" class="form-control" name="m" id="m" placeholder="模块名如admin">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="c" class="col-sm-2 control-label">控制器:</label>
                        <div class="col-sm-5">
                            <input type="text" class="form-control" name="c" id="c" placeholder="控制器如index">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="a" class="col-sm-2 control-label">方法:</label>
                        <div class="col-sm-5">
                            <input type="text" class="form-control" name="f" id="a" placeholder="方法名如index">
                        </div>
                    </div>
