			...
			<div class="col-lg-6">
				...
				<form class="form-horizontal" id="position-edit-form">
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" name="pos_name" class="form-control" id="inputname" placeholder="请填写推荐位名称" value="<?php echo ($position['pos_name']); ?>">
						</div>
					</div>
					<!-- 填写推荐位描述 -->
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" class="form-control" name="description" id="inputPassword3" placeholder="请填写推荐位描述" value="<?php echo ($position['description']); ?>">
						</div>
					</div>
					<!-- 选择推荐位状态 -->
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="radio" name="status" value="1" <?php if(($position['status']) == "1"): ?>checked<?php endif; ?>> 开启
							<input type="radio" name="status" value="0" <?php if(($position['status']) == "0"): ?>checked<?php endif; ?>> 关闭
						</div>
					</div>
