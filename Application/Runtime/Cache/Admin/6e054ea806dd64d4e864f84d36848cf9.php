  ...
  <div id="page-wrapper">
    ...
    <div class="container-fluid">
      ...
      <div class="row">
        <div class="col-lg-6">
          <!-- 推荐位编辑表单 -->
          <form class="form-horizontal" id="position-edit-form">
            <!-- 填写推荐位名称 -->
            <div class="form-group">
              <label for="positionName" class="col-sm-2 control-label">名称：</label>
              <div class="col-sm-5">
                <input type="text" name="pos_name" class="form-control" id="positionName" placeholder="请填写推荐位名称" value="<?php echo ($position['pos_name']); ?>">
              </div>
            </div>
            <!-- 填写推荐位描述 -->
            <div class="form-group">
              <label for="positionStatus" class="col-sm-2 control-label">描述：</label>
              <div class="col-sm-5">
                <input type="text" class="form-control" name="description" id="positionStatus" placeholder="请填写推荐位描述" value="<?php echo ($position['description']); ?>">
              </div>
            </div>
            <!-- 选择推荐位状态 -->
            <div class="form-group">
              ...
              <div class="col-sm-5">
                <input type="radio" name="status" value="1" title="开启" <?php if(($position['status']) == "1"): ?>checked<?php endif; ?>> 开启
                <input type="radio" name="status" value="0" title="关闭" <?php if(($position['status']) == "0"): ?>checked<?php endif; ?>> 关闭
              </div>
            </div>

            <input type="hidden" name="pos_id" value="<?php echo ($position['pos_id']); ?>">

            <!-- 保存 -->
            <div class="form-group">
              <div class="col-sm-offset-2 col-sm-10">
                <button type="button" class="btn btn-default" id="position-edit-save">保存</button>
              </div>
            </div>
          </form>
