...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
  ...
  <div class="navbar-header">
    ...
    <a class="navbar-brand" >thinkinfo管理平台</a>
  </div>
  <!-- Top Menu Items -->
	...
	<div class="container-fluid">
		...
		<div class="row">
			<div class="col-lg-6">
				...
				<form class="form-horizontal" id="position-content-edit-form">
					<div class="form-group">
						<label for="inputname" class="col-sm-2 control-label">标题:</label>
						<div class="col-sm-5">
							<input type="text" name="title" class="form-control" id="inputname" placeholder="请填写标题" value="<?php echo ($posc['title']); ?>">
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-5">
							<select class="form-control" name="pos_id">
                              ...
                              <?php if(is_array($positions)): $i = 0; $__LIST__ = $positions;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$position): $mod = ($i % 2 );++$i;?><option value="<?php echo ($position['pos_id']); ?>" <?php if(($posc['pos_id']) == $position['pos_id']): ?>selected<?php endif; ?>><?php echo ($position['pos_name']); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
							</select>
						</div>
					</div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-5">
                      ...
                      <img style="<?php echo (showThumb($posc['thumb'])); ?>" id="thumb-Img" src="<?php echo ($posc['thumb']); ?>" alt="缩略图">
                      <input type="hidden" id="thumb" name="thumb" value="<?php echo ($posc['thumb']); ?>">
                    </div>
                  </div>
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" class="form-control" name="url" id="inputPassword3" placeholder="请填写url地址" value="<?php echo ($posc['url']); ?>">
						</div>
					</div>
					<div class="form-group">
						<label for="inputname" class="col-sm-2 control-label">文章id:</label>
						<div class="col-sm-5">
							<input type="text" name="article_id" class="form-control" id="inputname" placeholder="如果和文章无关联的可以不添加文章id" value="<?php echo ($posc['article_id']); ?>">
						</div>
					</div>

					<input type="hidden" name="posc_id" value="<?php echo ($posc['posc_id']); ?>">

					<div class="form-group">
						<div class="col-sm-offset-2 col-sm-10">
							<button type="button" class="btn btn-default" id="position-content-save">保存</button>
						</div>
					</div>
				</form>
