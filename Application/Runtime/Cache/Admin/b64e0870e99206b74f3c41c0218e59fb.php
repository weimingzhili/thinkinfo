            ...
            <div class="col-lg-6">
                ...
                <form class="form-horizontal" id="user-edit-form">
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input type="text" name="username" class="form-control" id="inputname" value="<?php echo ($admin['username']); ?>">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input type="text" class="form-control" name="realname" id="inputPassword3" value="<?php echo ($admin['realname']); ?>">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input type="email" class="form-control" name="email" id="inputPassword3" value="<?php echo ($admin['email']); ?>">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-2 col-sm-10">
                            <button type="button" class="btn btn-default" id="user-edit-save">保存</button>
                        </div>
                    </div>
                </form>
