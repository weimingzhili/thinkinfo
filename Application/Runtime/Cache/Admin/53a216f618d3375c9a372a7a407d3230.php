    ...
    <div class="container-fluid">
      ...
      <div class="row">
        <div class="col-lg-6">
          ...
          <form class="form-horizontal" id="user-personal-form">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-5">
                <input type="text" class="form-control" name="realname" id="realName" value="<?php echo ($admin['realname']); ?>">
              </div>
            </div>

            <div class="form-group">
              <label class="col-sm-2 control-label" for="email">个人邮箱:</label>
              <div class="col-sm-5">
                <input type="text" class="form-control" name="email" id="email" value="<?php echo ($admin['email']); ?>">
              </div>
            </div>
            ...
            <div class="form-group">
              <div class="col-sm-offset-2 col-sm-10">
                <button type="button" class="btn btn-default" id="user-personal-save">保存</button>
              </div>
            </div>
          </form>
